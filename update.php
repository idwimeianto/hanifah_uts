...
echo '<div class="container" id="gc">';
    echo '<div class="container border" id="myc">';
            ...
            // <!-- Form -->
    echo    '<form class="m-4" action="update_submit.php?key=' . $key . '" method="POST" name="myform">';?>
                <!-- Nama -->
...
<div class="container" style=" height: 100%;
  ...
  border-radius: 5px 0;">
    <form action="new_submit.php" method="post">
        <h1 style="text-align: center; margin: 10px; font-size: 35px;">Update Mahasiswa</h1>
        ...
        <div class="form-group">
            ...
            <select placeholder="Disabled input" class="form-select" id="Angkatan" name="Angkatan" value=<?=$Angkatan;?> aria-label="Default select example"  name="angkatan">
        ...
        <div class="form-group">
            ...
            <select placeholder="Disabled input" class="form-select" id="Kelas" name="Kelas" value=<?=$Kelas;?> aria-label="Default select example"  name="class">
        ...
        <div>
            <label class="form-label">Jenis Kelamin</label>
                <div class="form-check form-check-inline" id="Jenis_Kelamin" >
                    <input class="form-check-input" type="radio" name="Jenis_Kelamin" id="jk1" value=<?='Laki-laki'?> checked=" <?php if ($Jenis_Kelamin == 'Laki-laki'){ echo 'checked'; } ?>">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="Nomor_Handphone" value=<?=$Nomor_Handphone;?>>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select placeholder="Disabled input" class="form-select" id="Bobot_Nilai" name="Bobot_Nilai" value=<?=$Bobot_Nilai;?> aria-label="Default select example"  name="Nilai">
