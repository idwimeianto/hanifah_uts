...
CREATE TABLE `mahasiswa` (
  ...
  `Bobor_Nilai` varchar(255) DEFAULT NULL,
...
INSERT INTO `mahasiswa` (`ID`, `NIM`, `Angkatan`, `Kelas`, `Jenis_Kelamin`, `Nama`, `Alamat`, `Hobi`, `Tempat_Lahir`, `Tanggal_Lahir`, `Nomor_Handphone`, `Cita-cita`, `Pembimbing_Akademik`, `Nama_MK`, `Kode_MK`, `Dosen_MK`, `UKM`, `UKK`, `Organisasi`, `Bobor_Nilai`, `Bobot_Angka`, `Email`) VALUES
